...
export const Modal: React.FC<ModalProps> = (props) => {
  const { isOpen, title, onClose, error, size = 'md' } = props;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center sm:p-4">
      <div
        ...
        onClick={onClose}
      />
      <div className={`relative z-10 flex max-h-[90vh] w-full flex-col rounded-t-2xl border border-neutral-200 bg-white shadow-xl sm:max-h-[85vh] sm:rounded-2xl dark:border-neutral-800 dark:bg-neutral-900 ${sizeClasses[size]}`}>
        <div className="flex shrink-0 items-center justify-between border-b border-neutral-100 p-4 sm:p-6 sm:pb-4 dark:border-neutral-800">
          ...
          <button
            ...
            className="-mr-2 flex h-8 w-8 items-center justify-center rounded-full text-neutral-500 transition-colors hover:bg-neutral-100 disabled:opacity-50 dark:text-neutral-400 dark:hover:bg-neutral-800"
          >
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 sm:pt-4">
          {error && (
